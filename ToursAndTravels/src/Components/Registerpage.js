        ...
        <div className="second-layer">
          <div className="third-layer">
            <div className="register-page">
              ...
              <button className="register-btn" onClick={validateAll}>Register</button>
              </div>
              <p className="register-page-text">Already have an Account? <strong className="register-login">Login</strong></p>
            </div>
          </div>
        </div>
      </div>
